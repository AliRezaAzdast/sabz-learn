          ...
          <div className="main-header__content">
            <div className="main-header__right">
              ...
              <ul className="main-header__menu">
                ...
                <li className="main-header__item">
                  <div className="main-header__link">فرانت اند
                ...
                <li className="main-header__item">
                  <div className="main-header__link">امنیت
                    <i className="fas fa-angle-down main-header__link-icon"></i>
                    <ul className="main-header__dropdown">
                      <li className="main-header__dropdown-item">
                ...
                <li className="main-header__item">
                  <div className="main-header__link">مقالات
                    <i className="fas fa-angle-down main-header__link-icon"></i>
                    <ul className="main-header__dropdown">
                      <li className="main-header__dropdown-item">
                ...
                <li className="main-header__item">
                  <div className="main-header__link">پایتون
                    <i className="fas fa-angle-down main-header__link-icon"></i>
                    <ul className="main-header__dropdown">
                      <li className="main-header__dropdown-item">
            ...
            <div className="main-header__left">
              ...
              <a href="#" className="main-header__profile">
                <span className="main-header__profile-text">علیرضاازدست</span>
              </a>
            </div>
          </div>
        </div>
